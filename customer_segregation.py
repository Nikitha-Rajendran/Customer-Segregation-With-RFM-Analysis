#number of samples in dataset - 5009
...
def main(argv):
   ...
   try:
      opts, args = getopt.getopt(sys.argv[1:],"h:i:o:d:",['ifile','ofile','dinputdate'])
...
def rfm(inputfile, outputfile, inputdate):
   ...
   # Open orders file
   orders = pd.read_csv(inputfile, sep=',',encoding="ISO-8859-1",engine='python')
   orders['order_date'] = pd.to_datetime(orders['order_date'],errors='ignore')
